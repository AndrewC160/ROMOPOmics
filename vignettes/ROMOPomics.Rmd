...
omop_db     <- buildSQLDBR(db_inputs,sql_db_file = file.path(dirs$data,"sqlDB.sqlite"))
...
msks        <- list(brca_clinical=loadModelMasks(file.path(dirs$masks,"brca_clinical_mask.csv")),
                    brca_mutation=loadModelMasks(file.path(dirs$masks,"brca_mutation_mask.csv")))
...
msk_file    <- file.path(dirs$masks,"GSE60682_standard_mask.csv")
