...
msks        <- list(brca_clinical=loadModelMasks(file.path(dirs$data,"brca_clinical_mask.csv")),
                    brca_mutation=loadModelMasks(file.path(dirs$data,"brca_mutation_mask.csv")))
...
msk_file    <- file.path(dirs$data,"GSE60682_standard_mask.csv")
msks        <- loadModelMasks(msk_file)

in_file     <- file.path(dirs$data,"GSE60682_standard.csv")
