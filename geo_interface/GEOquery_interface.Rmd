...
![fetch_geo_datasets() output.](`r file.path(base_dir,"geo_import_datasets.png")`){width=50%}
...
![fetch_geo_series() output.](`r file.path(base_dir,"geo_import_series.png")`){width=50%}
...
stevens_gse_lst <- fetch_geo_series(gse_ids,data_dir = data_dir)
