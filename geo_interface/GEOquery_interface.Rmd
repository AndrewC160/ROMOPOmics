...
geos  <- fetch_geo_datasets(geo_dataset_ids = c("GSE000001","GSE000002","GSE000003"),data_dir = data_dir)
md    <- geos$merged_metadata
```
...
write.table(arrange(geo_list$blank_mask,na_count),file=file.path(base_dir,"geo_interface/example_mask.tsv"),sep="\t",row.names=FALSE,quote=FALSE)
values      <- sum_m_data %>% 
