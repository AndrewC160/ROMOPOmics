...
msks        <- list(brca_clinical=loadModelMasks(file.path(dirs$data,"brca_clinical_mask.tsv")),
                    brca_mutation=loadModelMasks(file.path(dirs$data,"brca_mutation_mask.tsv")))
...
msk_file    <- file.path(dirs$data,"GSE60682_standard_mask.tsv")
